...
export default function RegisterPage() {
    ...
    const handleRegister = async (formData: FormData) => {
        ...
        try {
            ...
            console.log('Registro com sucesso:', response);
        ...
        <div className="min-h-screen bg-[#F3F4F6] flex items-center justify-center p-4 font-sans">
            <div className="bg-[#FFFFFF] w-full max-w-sm rounded-3xl shadow-lg overflow-hidden flex flex-col relative">
                ...
                <div className="bg-[#0D9488] pt-16 pb-12 relative flex-shrink-0">
                    <h1 className="text-3xl font-bold text-white text-center relative z-10">Register</h1>
                ...
                <div className="px-8 pt-2 pb-8 bg-[#FFFFFF] flex-grow">
                    <form className="space-y-4" action={handleRegister}>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-[#1F2937] mb-1 ml-1">Name</label>
                            <input
                                name="name"
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-[#1F2937] mb-1 ml-1">Confirm Password</label>
                            <input
                    ...
                    <div className="mt-6 text-center text-sm text-[#1F2937]">
                        Do you have an account? <Link href="/auth/login" className="text-[#0D9488] font-bold hover:underline">Log In</Link>
                    </div>
